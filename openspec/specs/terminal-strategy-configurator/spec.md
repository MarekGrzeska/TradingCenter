# terminal-strategy-configurator Specification

## Purpose
Ekran, na którym powstaje rewizja: skąd konfigurator bierze wybieraki, jak pokazuje rewizję jako
pochodzenie decyzji, i czego obiecywać nie wolno — bo złożenie strategii nie jest jej uruchomieniem.
## Requirements

...
- [x] 8.2 Przepuścić `ruff` i pełny zestaw testów na czysto
- [x] 8.3 Napisać README modułu — co / uruchomienie / testy / kontrakt — na jeden ekran, razem z kształtami wiadomości WebSocketa
- [x] 8.4 Napisać README repozytorium i `docs/architecture.md` ustanawiające układ `modules/`

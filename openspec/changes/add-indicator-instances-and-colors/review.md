...
znaku. Zadanie 9.2 — sprawdzenie w uruchomionym terminalu — zostawione operatorowi,
stack jest jego.
...
Nie uruchamiane: `-m live` (z założenia), oraz ręczne sprawdzenie w przeglądarce (9.2).
...
- **Zadanie 9.2 niezamknięte**: trzy EMA w trzech kolorach w uruchomionym terminalu,
  przeżywające przeładowanie strony. Dev stack należy do operatora i nie był uruchamiany.

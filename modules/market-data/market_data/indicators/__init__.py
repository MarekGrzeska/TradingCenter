"""Wskaźniki techniczne, computed on the series this module already owns.
...
`catalogue.py` is the published list: what a wskaźnik is called, what it takes, what shape

"""Settings, and the guard that keeps this module off a live account.

The guard runs here rather than on the trading routes on purpose: a runtime check
...
class Settings(BaseSettings):
    ...
    @field_validator("capital_api_key", "capital_identifier", "capital_password")
    @classmethod

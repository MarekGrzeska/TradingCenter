...
export interface components {
    schemas: {
        /**
         * Candle
         * @description One candle, identified by symbol, resolution and the start of its period. Edges are optional
        ...
        /**
         * CandleChange
         * @description One candle, closed or still forming, said explicitly. One message kind for both, marked rather
        ...
        /**
         * CandleSource
         * @description Which way a candle reached the archive. The two are not equally trustworthy: a disconnected
        ...
        /**
         * CandlesOut
         * @description A range read, and everything needed to know what it is not saying. An empty series over a
        ...
        /**
         * ChunkState
         * @description One chunk's life. `interrupted` is reached only from `pending` or `running`, and only by this
        ...
        /**
         * CollectionState
         * @description Whether data is actually arriving, as far as the archive can tell. Being on the list proves
        ...
        /**
         * FormingCandleOut
         * @description The period being built right now, read rather than subscribed to. Not stored anywhere: it
        ...
        /**
         * FormingState
         * @description Why a read of the current period does or does not carry a candle. Four answers rather than a
         ...
         * @description One row of `GET /indicators` — everything a consumer needs to offer this indicator and draw
        ...
        /**
         * IndicatorResultOut
         * @description One requested indicator's answer. Exactly one of `lines`, `markers`, `zones`, `levels` is
        ...
        /**
         * PriceSide
         * @description Which side of the spread a candle is built from. Everything stored today is `BID`; the value is
        ...
        /**
         * Problem
         * @description A refusal that names itself. Never a database error and never a credential: a raw `asyncpg`
        ...
        /**
         * Snapshot
         * @description The first message on every subscription, and the only one that looks backwards. The settled
        ...
        /**
         * StreamTicketOut
         * @description Permission to open the stream once, and how long it stays good for. The lifetime is answered
        ...
        /**
         * TrackPairRequest
         * @description Body for `POST /pairs`. Two shapes, never mixed: the single-pair one and a multi-pair one,

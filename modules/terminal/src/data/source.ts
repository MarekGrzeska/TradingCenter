...
/** Wskaźniki: the catalogue every picker builds from, and the computation behind it.
...
export interface IndicatorSource {
  /** Every wskaźnik this source can compute, and how to draw each one. A consumer
   *  builds its whole picker from this and never needs to know a wskaźnik by name
  ...
  /** One or more wskaźniki over a range, on one shared time axis. Rejects with a

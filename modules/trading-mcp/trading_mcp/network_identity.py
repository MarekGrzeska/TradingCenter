...
network_identity.py`, copied rather than shared (no shared library between modules).
...
(specs/trading-mcp-transport, "Wołający jest wskazany imiennie").
"""
...
# probe carries none (specs/trading-mcp-transport, "Zdrowie modułu da się sprawdzić
# bez sesji MCP").
EXEMPT_PATHS = {"/health"}

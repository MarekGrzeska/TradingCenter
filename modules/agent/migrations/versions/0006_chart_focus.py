...
def upgrade() -> None:
    op.drop_constraint("chart_commands_sets_something", "chart_commands", type_="check")
    op.add_column("chart_commands", sa.Column("focus", postgresql.JSONB(), nullable=True))
    op.create_check_constraint(
        "chart_commands_sets_something",
        "chart_commands",
...
def downgrade() -> None:
    ...
    op.drop_constraint("chart_commands_sets_something", "chart_commands", type_="check")
    op.drop_column("chart_commands", "focus")
    op.create_check_constraint(
        "chart_commands_sets_something",
        "chart_commands",
        "symbol IS NOT NULL OR resolution IS NOT NULL OR indicators IS NOT NULL",
